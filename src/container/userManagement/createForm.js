...
export function TextCustom({ onChange, value, name, placeholder, label, checkValidate, type }) {
	return (
		<TextField
			id="outlined-basic"
			value={value}
			...
			onChange={onChange}
			inputProps={{
				maxLength: name === 'pin' ? 6 : name === 'bankAccount' || name === 'tel' ? 10 : '',
			}}
			name={name}
			disabled={name === 'tel' && type === 'edit'}
